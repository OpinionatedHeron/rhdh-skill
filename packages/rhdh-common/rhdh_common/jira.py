...
nested payload. The custom-field IDs below are the reason this lives here: they
are instance facts, and a second copy of them silently drifts.

    from rhdh_common.jira import FIELDS, enrich, flatten
"""
