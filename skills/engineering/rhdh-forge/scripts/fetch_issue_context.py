...
# ///
"""Fetch a GitHub issue and output IssueContext/v1 as JSON.
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch a GitHub issue and output IssueContext/v1 as JSON."
    )
    parser.add_argument(
        "issue",
    ...
    artifact = {
        ...
        "id": f"github-{safe_repo}-issue-{number}",
    ...
    log(f"Done. state={artifact['data']['state']} workspace={workspace or 'unresolved'}")
