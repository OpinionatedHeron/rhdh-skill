...
The template has conditional sections. Include or omit them based on the resolved issue context and `ChangeHandoff/v1` from Step 1.5.

```
## Description
<generated description — 2-4 sentences explaining what changed and why>

<pr_description_extra — if derived from ChangeHandoff/v1 data.rootCause, insert here>
...
## Note                                ← include for a bug-fix ChangeHandoff/v1
> This bug fix was implemented with /rhdh-plugin-development and published with /rhdh-pull-request. Please verify it thoroughly before merging.
```
