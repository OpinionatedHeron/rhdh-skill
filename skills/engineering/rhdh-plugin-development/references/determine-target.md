...
RHDH pins a specific Backstage version per release. Use `RhdhContext/v1`
established by `SKILL.md` or query the named `/rhdh-context` skill for one.
...
|---|---|
| Use the resolved `RhdhContext/v1`; do not infer from an unrelated release |
