...
Pass GIF paths in `ChangeHandoff/v1.data.recordings`. `/rhdh-pull-request` uploads them
to a dedicated `screenrecordings` branch on the user's fork, keeping them out
of the feature diff and upstream `main`.
