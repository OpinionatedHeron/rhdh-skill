...
Return capability status in `SetupReceipt/v1`; do not include the user name, kubeconfig contents,
bearer token, or request headers. Any configuration change follows the setup mutation contract.
