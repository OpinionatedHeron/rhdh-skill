# Workspace Map: Jira Components to rhdh-plugins Workspaces

Maps Jira issue **Component** fields to workspace directories in `rhdh-plugins`. Used in Step 2 to identify which workspace a bug belongs to.
...
| Localization | `translations` | Yes | unknown |
...
2. Check for known aliases (e.g., "Localization" → `translations`)
